...
public class SinaConsumer {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind(Consts.QUEUE_WEATHER_SINA, Consts.EXCHANGE_WEATHER_ROUTING, "china.shanghai");
        channel.queueBind(Consts.QUEUE_WEATHER_SINA, Consts.EXCHANGE_WEATHER_ROUTING, "china.beijing");
