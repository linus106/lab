package com.linus.lab.rabbitmq.routing;
...
public class BaiduConsumer {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind(Consts.QUEUE_WEATHER_BAIDU, Consts.EXCHANGE_WEATHER_ROUTING, "");
//        channel.queueBind(Consts.QUEUE_WEATHER_BAIDU, Consts.EXCHANGE_WEATHER_ROUTING, "china.beijing");
//        channel.queueBind(Consts.QUEUE_WEATHER_BAIDU, Consts.EXCHANGE_WEATHER_ROUTING, "japan.tokyo");
